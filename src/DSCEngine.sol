...
contract DSCEngine is ReentrancyGuard {
    ...
    mapping(address collateralToken => address priceFeed) private s_priceFeeds; //token to price feed
     ...
     *
     * In order to do that, we need total DSC minted and total collateral VALUE
     */
    ...
    function getUsdValue(
        ...
        // 1e8 because in chainlink we know that ETH and BTC are returning 1e8
        return
    ...
    function getTokenAmountFromUsd(
        ...
        // 100 0000000000 00000000 * 10000000000 00000000 / 2000 00000000 * 10000000000
        // = 0.05000000 0000000000
